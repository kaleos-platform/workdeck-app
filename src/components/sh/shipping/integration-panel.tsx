  ...
  const fetchPreview = useCallback(async () => {
    ...
    try {
      ...
      const filteredBatches = (
        json.data as { completedAt: string | null; orderCount: number }[]
      ).filter((b: { completedAt: string | null }) => {
      ...
      <Dialog open={pushDialogOpen} onOpenChange={setPushDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>배송 관리 데이터를 재고 관리 덱으로 전송합니다.</DialogDescription>
          </DialogHeader>
          ...
          {!pushResult ? (
            <div className="space-y-4 py-2">
              ...
              <DialogFooter>
                ...
                <Button onClick={handlePush} disabled={pushing || !selectedLocationId}>
