...
export function SettingsPanel() {
  ...
  const [defaultLocationId, setDefaultLocationId] =
    useState<string>(NO_LOCATION_VALUE)
  ...
  async function handleSave() {
    ...
    try {
      const payload = {
        defaultLocationId:
          defaultLocationId === NO_LOCATION_VALUE ? null : defaultLocationId,
      ...
      if (data?.settings) {
        setDefaultLocationId(
          data.settings.defaultLocationId ?? NO_LOCATION_VALUE,
        )
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            />
            <p className="text-xs text-muted-foreground">
              대량 재고 조정 시 알림이 전송됩니다 (https://hooks.slack.com/...
              형식)
            </p>
            {webhookInvalid && (
          ...
          <ol className="space-y-3 text-sm">
            <li className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                >
                  <Link href="/d/inventory-mgmt/locations">
                    위치 관리로 이동 →
                  </Link>
                </Button>
              </div>
            ...
            <li className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <Button
                  ...
                  className="h-auto p-0"
                >
                  <Link href="/d/inventory-mgmt/movements">
                    입출고 관리로 이동 →
                  </Link>
                </Button>
              </div>
            ...
            <li className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <Button
                  ...
                  className="h-auto p-0"
                >
                  <Link href="/d/inventory-mgmt/channels">
                    판매 채널 관리로 이동 →
                  </Link>
                </Button>
              </div>
