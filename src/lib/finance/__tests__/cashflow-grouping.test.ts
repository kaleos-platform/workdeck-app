...
const INCOME: CashflowLeaf[] = [
  leaf({ key: 'A', type: 'INCOME', parentId: 'P1', parentName: '매출대분류', flowRole: 'MERCH_SALES', values: { '2026-06': 100, '2026-07': 200 } }),
  leaf({ key: 'B', type: 'INCOME', parentId: 'P1', parentName: '매출대분류', flowRole: 'MERCH_SALES', values: { '2026-06': 50, '2026-07': 0 } }),
  leaf({ key: 'C', type: 'INCOME', parentId: 'P2', parentName: '기타수입', flowRole: null, values: { '2026-06': 30, '2026-07': 10 } }),
  leaf({ key: '미분류수입', type: 'INCOME', parentId: null, parentName: '미분류', flowRole: null, values: { '2026-06': 5, '2026-07': 0 } }),
]
// 지출 리프: 고정(D), 변동(E), 미지정(F)
const EXPENSE: CashflowLeaf[] = [
  leaf({ key: 'D', type: 'EXPENSE', parentId: 'E1', parentName: '인건비', groupLabel: '고정', values: { '2026-06': 40, '2026-07': 20 } }),
  leaf({ key: 'E', type: 'EXPENSE', parentId: 'E1', parentName: '인건비', groupLabel: '변동', values: { '2026-06': 10, '2026-07': 5 } }),
  leaf({ key: 'F', type: 'EXPENSE', parentId: 'E2', parentName: '기타지출', groupLabel: null, values: { '2026-06': 7, '2026-07': 0 } }),
]
