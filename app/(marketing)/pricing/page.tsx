...
export function generateMetadata(): Metadata {
  return buildMarketingMetadata({
    title: '요금제 — Workdeck',
    description:
      'Workdeck은 현재 전 deck 베타 기간 동안 무료입니다. deck별 정식 전환 예정가와 이용 조건을 확인하세요.',
    path: '/pricing',
    keywords: ['Workdeck 요금제', 'Workdeck 가격', 'deck 구독료'],
  })
}
...
const faq: DeckLandingFaqItem[] = [
  {
    ...
    answer:
      '현재 전 deck이 베타 기간으로 무료입니다. 정식 유료 전환 일정은 확정되는 대로 서비스 내 공지와 이메일로 사전 안내드립니다.',
  },
  {
  ...
  {
    question: '여러 deck을 한 번에 구독해야 하나요?',
    answer:
      '아니요. deck은 필요한 것만 골라 구독하는 방식입니다. 정식 전환 이후에도 사용하지 않는 deck까지 강제로 결제되지 않습니다.',
  },
  {
    question: '해지는 어떻게 하나요?',
    answer:
      '정식 유료 전환 이후 워크스페이스 설정에서 deck별로 언제든 해지할 수 있으며, 이미 결제한 기간까지는 정상적으로 이용할 수 있습니다.',
  },
]
      ...
      <section className="px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
        <div className="mx-auto max-w-3xl space-y-6 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg break-keep text-muted-foreground">
            Workdeck의 모든 deck은 베타 기간 동안 무료로 이용할 수 있습니다. 아래는 정식 전환 시
      ...
      <section className="border-t bg-muted/30 px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mx-auto mt-10 max-w-2xl text-center text-sm break-keep text-muted-foreground">
            ...
            필요한 deck만 선택해 구독할 수 있으며, 정식 전환 일정과 조건은 사전 공지됩니다.
          </p>
        </div>
      </section>
