...
import { claimNextBoJob, reapStaleBoClaims } from '@/lib/bo/jobs'
import { getBoCredential } from '@/lib/bo/credentials'
import { prisma } from '@/lib/prisma'

const BO_JOB_KINDS = ['CRAWL_HOMEPAGE', 'GENERATE_DRAFT', 'GENERATE_VARIANT', 'PUBLISH'] as const
