...
import { DECK_CATALOG_DEFAULTS } from '../src/lib/billing/catalog-defaults'
...
async function main() {
  ...
  const deckApps = [
    ...
    { id: 'blog-ops', name: '블로그 운영', isActive: false }, // 폐기 (2026-08)
  ...
  // 단일소스: src/lib/billing/catalog-defaults.ts (마케팅 pricing 페이지와 공유)
  for (const p of DECK_CATALOG_DEFAULTS) {
