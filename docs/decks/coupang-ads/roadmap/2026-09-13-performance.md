...
- [x] 홈 재진입 1초 목표: full prefetch 배포 후 5회 최대 0.834초, 중앙값 0.071초. My Deck 링크 진입도 5회 최대 0.945초.
- [ ] 직접 URL 최초 진입 3초 목표: 최신 인덱스 탐색 배포 직후 4.181초(DOM 4.057초) 표본이 남음. 날짜 범위 집계·인증·함수 초기화 구간을 추가 개선해야 함.
- [ ] 상세 재진입 1초 목표 안정화: 2026-09-23 첫 cycle에서 1.990초 표본 관측. 나머지 4회는 0.286~0.462초. 이전 배포의 목표 충족 결과와 구분함.
